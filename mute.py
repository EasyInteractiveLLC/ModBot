...
#pip install -U git+https://github.com/discord/discord.git#master 
  @commands.hybrid_command(description="Mute Member")
  ...
  async def mute(self, ctx, member: discord.Member, time=None, *, reason="None was provided"):
    ...
    role = discord.utils.get(ctx.guild.roles, name="Core Utilities")
    if member.top_role.position > ctx.author.top_role.position:
      return await ctx.send(f":x: **You cant do that, {member.name} is higher than you**")
  ...
  @commands.hybrid_command(description="Unmute Member")
  @commands.has_permissions(manage_roles=True)
